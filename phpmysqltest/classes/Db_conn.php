...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'damonti';//this will be your WCC username
      $dbUsr = 'damonti';//this will be your WCC username
      $dbPass = '5HbA8REYxfFU';//this will be the password found in the video.
